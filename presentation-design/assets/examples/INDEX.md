...
- Пример Teaching Lab с эмоджи показывает систему размеров и ролей, а не
  разрешение украшать каждый слайд случайными эмоджи.
- Пример Teaching Lab с предметным изображением показывает, как отделить
  будущий PNG/JPG/WebP от редактируемых подписей, стрелок и учебного задания.

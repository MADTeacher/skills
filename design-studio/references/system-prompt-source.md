...
The original source material provided by the user is preserved below without
semantic compression. This is an audit and recovery layer, not the main working
skill document.

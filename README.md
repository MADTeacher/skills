...
| `mad-presentation-design` | Создание, доработка, проверка и экспорт презентаций в HTML, PPTX, PDF, PNG и связанных форматах. | [SKILL.md](./mad-presentation-design/SKILL.md) |
